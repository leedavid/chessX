...
QT_MOC_LITERAL(1, 7, 14), // "searchProgress"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 14) // "searchFinished"

    },
    "Filter\0searchProgress\0\0searchFinished"
};
...
void Filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Filter::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Filter::searchProgress)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Filter::searchFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Filter::searchProgress(int _t1)
{
