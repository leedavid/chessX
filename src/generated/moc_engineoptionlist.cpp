...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EngineOptionListDelegate_t, stringdata0) + ofs \
...
void EngineOptionListDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EngineOptionListDelegate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EngineOptionListDelegate::staticMetaObject = { {
    &QStyledItemDelegate::staticMetaObject,
    qt_meta_stringdata_EngineOptionListDelegate.data,
    qt_meta_data_EngineOptionListDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *EngineOptionListDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EngineOptionListDelegate.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_EngineOptionList_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
QT_INIT_METAOBJECT const QMetaObject EngineOptionList::staticMetaObject = { {
    &TableView::staticMetaObject,
    qt_meta_stringdata_EngineOptionList.data,
    qt_meta_data_EngineOptionList,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_EngineOptionList.stringdata0))
        return static_cast<void*>(this);
