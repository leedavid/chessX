...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BoardSearchDialog_t, stringdata0) + ofs \
...
void BoardSearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BoardSearchDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject BoardSearchDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_BoardSearchDialog.data,
    qt_meta_data_BoardSearchDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BoardSearchDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BoardSearchDialog.stringdata0))
