...
QT_MOC_LITERAL(1, 12, 17), // "halfMoveRequested"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "ChartWidget\0halfMoveRequested\0"
};
...
void ChartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->halfMoveRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ChartWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChartWidget::halfMoveRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChartWidget::halfMoveRequested(int _t1)
{
