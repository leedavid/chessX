...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CtgBookWriter_t, stringdata0) + ofs \
...
void CtgBookWriter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CtgBookWriter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CtgBookWriter::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CtgBookWriter::bookBuildFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CtgBookWriter::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CtgBookWriter::bookBuildError)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CtgBookWriter::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_CtgBookWriter.data,
    qt_meta_data_CtgBookWriter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CtgBookWriter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CtgBookWriter.stringdata0))
