...
QT_MOC_LITERAL(10, 97, 19), // "keySequenceFinished"
QT_MOC_LITERAL(11, 117, 17) // "clearShortcutText"

    },
    "ActionDialog\0signalResetKey\0\0accept\0"
    "reject\0saveOldActionText\0row\0column\0"
    "validateAction\0resetKeys\0keySequenceFinished\0"
    "clearShortcutText"
};
...
void ActionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->keySequenceFinished(); break;
        case 7: _t->clearShortcutText(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ActionDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ActionDialog::signalResetKey)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActionDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ActionDialog.data,
    qt_meta_data_ActionDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
