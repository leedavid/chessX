...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TelnetClient_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(4, 40, 22), // "SlotSocketDisconnected"
QT_MOC_LITERAL(5, 63, 20), // "SlotReadTimesealData"
QT_MOC_LITERAL(6, 84, 17) // "SlotTimesealError"

    },
    "TelnetClient\0disconnected\0\0SlotReadData\0"
    "SlotSocketDisconnected\0SlotReadTimesealData\0"
    "SlotTimesealError"
};
...
void TelnetClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TelnetClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TelnetClient::disconnected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TelnetClient::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_TelnetClient.data,
    qt_meta_data_TelnetClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TelnetClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TelnetClient.stringdata0))
