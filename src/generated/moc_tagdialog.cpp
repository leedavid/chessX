...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TagDialog_t, stringdata0) + ofs \
...
void TagDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TagDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TagDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_TagDialog.data,
    qt_meta_data_TagDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TagDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TagDialog.stringdata0))
