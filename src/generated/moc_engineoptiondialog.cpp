...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EngineOptionDialog_t, stringdata0) + ofs \
...
void EngineOptionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EngineOptionDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EngineOptionDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_EngineOptionDialog.data,
    qt_meta_data_EngineOptionDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *EngineOptionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EngineOptionDialog.stringdata0))
