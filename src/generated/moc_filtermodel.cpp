...
#include <memory>
#include "../database/filtermodel.h"
...
QT_MOC_LITERAL(1, 12, 14), // "searchProgress"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 14), // "searchFinished"
QT_MOC_LITERAL(4, 43, 9) // "endSearch"

    },
    "FilterModel\0searchProgress\0\0searchFinished\0"
    "endSearch"
};
...
void FilterModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->searchProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->searchFinished(); break;
        case 2: _t->endSearch(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FilterModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FilterModel::searchProgress)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FilterModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FilterModel::searchFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FilterModel::searchProgress(int _t1)
{
...
// SIGNAL 1
void FilterModel::searchFinished()
{
